...
cargo run -- tests/data/custom_style/input.sgf -n 120 --move-numbers=80 --custom-style tests/data/custom_style/wacky.toml -o demo/wacky.svg
cargo run -- tests/data/kifu/input.sgf --kifu --style minimalist -o demo/kifu.svg
